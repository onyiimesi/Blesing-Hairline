			...
			<div class="row">
				...
				<div class="col-lg-12 product-details">
                    ...
                    <?php 
                        ...
                        $stmt = $connection->prepare("SELECT posts.post_id, posts.post_category_id, posts.post_title, posts.post_price, posts.post_image, posts.post_content, posts.post_code, brands.brand_id, brands.brand_title FROM posts LEFT JOIN brands ON posts.post_category_id = brands.brand_id WHERE posts.post_category_id = ? && post_status = 'published' ");
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="product-pic mb-100">
                                            <img src="/hairline/img/posts/<?php echo $row['post_image']; ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="p-stocks"><?php echo $row['brand_title']; ?></h4><hr>
                                        <h2 class="p-title"><?php echo $row['post_title']; ?></h2>
                                        <h3 class="p-price">&#8358;<?php echo number_format($row['post_price'],0); ?></h3>
